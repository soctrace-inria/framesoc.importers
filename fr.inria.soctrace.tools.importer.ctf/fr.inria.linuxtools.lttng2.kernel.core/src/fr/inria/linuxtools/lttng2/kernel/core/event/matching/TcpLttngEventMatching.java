...
package fr.inria.linuxtools.lttng2.kernel.core.event.matching;

import java.util.ArrayList;
import java.util.List;
import java.util.Set;

import fr.inria.linuxtools.internal.lttng2.kernel.core.TcpEventStrings;
...
import fr.inria.linuxtools.tmf.core.event.matching.ITmfNetworkMatchDefinition;
import fr.inria.linuxtools.tmf.core.event.matching.TmfEventMatching.MatchingType;
import fr.inria.linuxtools.tmf.core.event.matching.TmfNetworkEventMatching.Direction;
import fr.inria.linuxtools.tmf.core.trace.ITmfTrace;
import fr.inria.linuxtools.tmf.core.trace.TmfEventTypeCollectionHelper;
