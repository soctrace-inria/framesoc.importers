...
import fr.inria.linuxtools.ctf.core.event.CTFCallsite;
...
import fr.inria.linuxtools.ctf.core.event.types.ArrayDefinition;
...
import fr.inria.linuxtools.internal.ctf.core.event.CTFCallsiteComparator;
...
public class CTFTrace implements IDefinitionScope, AutoCloseable {
     ...
     *            String
     * @return Definition
     * @see fr.inria.linuxtools.ctf.core.event.scope.IDefinitionScope#lookupDefinition(String)
     */
    @Override
