 ...
 *******************************************************************************/
package fr.inria.linuxtools.ctf.core.trace;
...
import fr.inria.linuxtools.ctf.core.CTFStrings;
import fr.inria.linuxtools.ctf.core.event.EventDefinition;
...
import fr.inria.linuxtools.ctf.core.event.scope.LexicalScope;
import fr.inria.linuxtools.ctf.core.event.types.Definition;
import fr.inria.linuxtools.ctf.core.event.types.IntegerDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.IntegerDefinition;
import fr.inria.linuxtools.ctf.core.event.types.SimpleDatatypeDefinition;
import fr.inria.linuxtools.ctf.core.event.types.StructDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.StructDefinition;
import fr.inria.linuxtools.ctf.core.event.types.VariantDefinition;
import fr.inria.linuxtools.internal.ctf.core.event.EventDeclaration;
import fr.inria.linuxtools.internal.ctf.core.trace.StreamInputPacketIndexEntry;
