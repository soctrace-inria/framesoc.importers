...
package fr.inria.linuxtools.internal.ctf.core.event.metadata;
...
import fr.inria.linuxtools.ctf.core.event.CTFClock;
import fr.inria.linuxtools.ctf.core.event.types.ArrayDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.Encoding;
import fr.inria.linuxtools.ctf.core.event.types.EnumDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.FloatDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.IDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.IntegerDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.SequenceDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.StringDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.StructDeclaration;
import fr.inria.linuxtools.ctf.core.event.types.VariantDeclaration;
import fr.inria.linuxtools.ctf.core.trace.CTFStream;
import fr.inria.linuxtools.ctf.core.trace.CTFTrace;
import fr.inria.linuxtools.ctf.parser.CTFParser;
import fr.inria.linuxtools.internal.ctf.core.Activator;
import fr.inria.linuxtools.internal.ctf.core.event.EventDeclaration;
import fr.inria.linuxtools.internal.ctf.core.event.metadata.exceptions.ParseException;
